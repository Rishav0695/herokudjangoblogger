...
EMAIL_HOST_USER= "djangopractice@zoho.com"
RMAIL_HOST_PASSWORD = "pythondjanog"
EMAIL_PORT =465
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,"templates")],#set the place from where the templates have to be picked.
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
